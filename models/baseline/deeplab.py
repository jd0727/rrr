from .define import *
from .resnet import ResNetBkbn
from .vgg import VGGBkbn
...
class DeepLabV2ResNetMain(ImageONNXExportable):
    ...
    def __init__(self, Module, nums_repeat, channels=64, act=ACT.RELU, norm=NORM.BATCH, num_cls=20, img_size=(224, 224),
                 in_channels=3):
    ...
    @staticmethod
    def ModuleRepeat(Module, in_channels, out_channels, num_repeat=1, stride=1, dilation=1, act=ACT.RELU,
                     norm=NORM.BATCH):
        backbone = []
...
class DeepLabV1VGGMain(ImageONNXExportable):
    def __init__(self, nums_repeat=(1, 1, 2, 2, 2), act=ACT.RELU, norm=NORM.BATCH, num_cls=20, img_size=(224, 224),
                 in_channels=3):
    ...
    @staticmethod
    def Ck3Repeat(in_channels, out_channels, num_repeat=1, pool_stride=1, dilation=1, act=ACT.RELU, norm=NORM.BATCH):
